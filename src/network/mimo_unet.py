...
class MIMOUNetPlus(nn.Module):
    def __init__(self, num_res = 20, in_channel=3):
...
def build_net(model_name, in_channel=3):
    ...
    if model_name == "MIMO-UNetPlus":
        return MIMOUNetPlus(in_channel=in_channel)
    elif model_name == "MIMO-UNet":
        return MIMOUNet(in_channel=in_channel)
